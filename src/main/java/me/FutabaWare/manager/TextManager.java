...
import me.FutabaWare.features.gui.font.CustomFont;
...
public class TextManager
    ...
    public void init(boolean startup) {
        FontMod cFont = FutabaWare.moduleManager.getModuleByClass(FontMod.class);
        try {
    ...
    public void drawString(String text, float x, float y, int color, boolean shadow) {
        if (FutabaWare.moduleManager.isModuleEnabled(FontMod.getInstance().getName())) {
            if (shadow) {
