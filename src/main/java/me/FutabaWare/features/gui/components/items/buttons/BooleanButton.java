...
public class BooleanButton
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        FutabaWare.textManager.drawStringWithShadow(this.getName(), this.x + 2.3f, this.y - 1.7f - (float) FutabaWareGui.getClickGui().getTextOffset(), this.getState() ? ColorUtil.toARGB(ClickGui.getInstance().red.getValue(), ClickGui.getInstance().green.getValue(), ClickGui.getInstance().blue.getValue(), 255) : -5592406 );
    }
