...
public class Button
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        FutabaWare.textManager.drawStringWithShadow(this.getName(), this.x + 2.3f, this.y - 2.0f - (float) FutabaWareGui.getClickGui().getTextOffset(), this.getState() ? ColorUtil.toARGB(ClickGui.getInstance().red.getValue(), ClickGui.getInstance().green.getValue(), ClickGui.getInstance().blue.getValue(), 255) : -5592406);
    }
    ...
    public boolean isHovering(int mouseX, int mouseY) {
        for (Component component : FutabaWareGui.getClickGui().getComponents()) {
