package me.FutabaWare.features.gui.components.items;
...
public class Description
    ...
    public static void deez(String desc, int color){
        if (open) {
            FutabaWare.textManager.drawStringWithShadow(desc, descX + 3.0f, descY + 7.0f, color);
            Description.descW = FutabaWare.textManager.getStringWidth(desc) + 6f;
        }
    }
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        FutabaWare.textManager.drawStringWithShadow("Description", descX + 3.0f, descY - 14.0f, -1);
    }
