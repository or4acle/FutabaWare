package me.FutabaWare.features.gui.components;
...
import me.FutabaWare.features.gui.components.items.buttons.Button;
...
public class Component
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        FutabaWare.textManager.drawStringWithShadow(this.getName(), (float) this.x + 3.0f, (float) this.y - 2.0f - (float) FutabaWareGui.getClickGui().getTextOffset(), -1);
    ...
    public void mouseClicked(int mouseX, int mouseY, int mouseButton) {
        if (mouseButton == 0 && this.isHovering(mouseX, mouseY)) {
            ...
            FutabaWareGui.getClickGui().getComponents().forEach(component -> {
                if (component.drag) {
