package me.FutabaWare.features;

import me.FutabaWare.FutabaWare;
import me.FutabaWare.manager.TextManager;
...
public abstract class Feature
    ...
    public Setting register(Setting setting) {
        ...
        if (this instanceof Module && Feature.mc.currentScreen instanceof FutabaWareGui) {
            FutabaWareGui.getInstance().updateModule((Module) this);
        }
        return setting;
    }
