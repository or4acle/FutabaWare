...
import me.FutabaWare.manager.ConfigManager;
...
public class ModuleCommand
    ...
    public void execute(String[] commands) {
        ...
        if (commands.length == 1) {
            ...
            for (Module.Category category : FutabaWare.moduleManager.getCategories()) {
                String modules = category.getName() + ": ";
                for (Module module1 : FutabaWare.moduleManager.getModulesByCategory(category)) {
        ...
        Module module = FutabaWare.moduleManager.getModuleByDisplayName(commands[0]);
        if (module == null) {
            module = FutabaWare.moduleManager.getModuleByName(commands[0]);
            if (module == null) {
