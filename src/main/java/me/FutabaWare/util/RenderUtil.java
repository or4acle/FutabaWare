...
import me.FutabaWare.features.modules.client.Colors;
import me.FutabaWare.features.modules.player.Speedmine;
import me.FutabaWare.util.ColorUtil;
import me.FutabaWare.util.EntityUtil;
import me.FutabaWare.util.GLUProjection;
import me.FutabaWare.util.Util;
...
public class RenderUtil
    ...
    public static void boxESP(BlockPos blockPos, Color color, float f, boolean bl, boolean bl2, int n, boolean bl3) {
        ...
        if (camera.isBoundingBoxInFrustum(new AxisAlignedBB(axisAlignedBB.minX + RenderUtil.mc.getRenderManager().viewerPosX, axisAlignedBB.minY + RenderUtil.mc.getRenderManager().viewerPosY, axisAlignedBB.minZ + RenderUtil.mc.getRenderManager().viewerPosZ, axisAlignedBB.maxX + RenderUtil.mc.getRenderManager().viewerPosX, axisAlignedBB.maxY + RenderUtil.mc.getRenderManager().viewerPosY, axisAlignedBB.maxZ + RenderUtil.mc.getRenderManager().viewerPosZ))) {
            ...
            float f2 = (float)Speedmine.getInstance().timer.getPassedTimeMs() / 1000.0f / (Speedmine.getInstance().breakTime * FutabaWare.serverManager.getTpsFactor());
            f2 = Math.min(f2, 1.0f);
            if (bl3) {
    ...
    public static void drawTextWhite(AxisAlignedBB axisAlignedBB, String string) {
        ...
        GlStateManager.disableDepth();
        GlStateManager.translate((double)(-((double)FutabaWare.textManager.getStringWidth(string) / 2.0)), (double)0.0, (double)0.0);
        FutabaWare.textManager.drawStringWithShadow(string, 0.0f, 0.0f, ColorUtil.toRGBA(255, 255, 255, 255));
        GlStateManager.popMatrix();
    }
    ...
    public static void drawWaypointImage(BlockPos pos, GLUProjection.Projection projection, Color color, String name, boolean rectangle, Color rectangleColor) {
        ...
        float textWidth = FutabaWare.textManager.getStringWidth(text);
        FutabaWare.textManager.drawString(text, -(textWidth / 2.0f), -((float)FutabaWare.textManager.getFontHeight() / 2.0f) + (float)FutabaWare.textManager.getFontHeight() / 2.0f, color.getRGB(), false);
        GlStateManager.translate((double)(-projection.getX()), (double)(-projection.getY()), (double)0.0);
        GlStateManager.popMatrix();
    }
    ...
    public static void drawText(AxisAlignedBB pos, String text) {
        ...
        GlStateManager.disableDepth();
        GlStateManager.translate((double)(-((double)FutabaWare.textManager.getStringWidth(text) / 2.0)), (double)0.0, (double)0.0);
        FutabaWare.textManager.drawStringWithShadow(text, 0.0f, 0.0f, -5592406);
        GlStateManager.popMatrix();
    }
    ...
    public static void drawProjectedText(GLUProjection.Projection projection, float addX, float addY, String text, Color color, boolean shadow) {
        if (projection.getType() == GLUProjection.Projection.Type.INSIDE) {
            GlStateManager.pushMatrix();
            GlStateManager.translate((double)projection.getX(), (double)projection.getY(), (double)0.0);
            FutabaWare.textManager.drawString(text, -((float)FutabaWare.textManager.getStringWidth(text) / 2.0f) + addX, addY, color.getRGB(), shadow);
            GlStateManager.translate((double)(-projection.getX()), (double)(-projection.getY()), (double)0.0);
            GlStateManager.popMatrix();
        }
    }
